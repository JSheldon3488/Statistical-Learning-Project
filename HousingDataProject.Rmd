...
```
By removing the outliers we had in the orignial data it gave us a better random spread of residuals in the resdiual vs. fitted plot. Although the QQ plot still has tails the deviate from normality and skews slightly right it is clear that they aren't as extreme as they were before. Without the outliers streaching the data we can get more accurate answers when asking questions and using this model.