...
Forward stepwise Selection revealed that the best model using this method is somewhere around 40-50 variables in the model. Remember this is not necessarly the best model because forward stepwise can get stuck in a suboptimal path. That being said it appears like around 50 variables will turn out to be a good model. The most interesting thing I found from doing forward stepwise was just determining which variables were selected first and therefore the potentially important variables in predicting sale price. Below is a list of the first 10 variables selected and their meaning in order of how they were selected by forward stepwise selection.
